...
for i in {1..5}
do
	python3 Ising_test_ellipsoid.py 4 150 0.01 0.5 50000 5.0 2.0
done
...
for i in {1..5}
do
	python3 Ising_test_noisyopt.py 4 150 0.01 0.1 50000 5.0 2.0 SPSA
done
...
for i in {1..5}
do
	python3 Ising_test_bohb.py 4 150 0.01 50000 5.0 2.0
done

# Collect results for Gasnikov
for i in {1..5}
do
	python3 Ising_test_gasnikov.py 4 150 0.01 0.5 50000 5.0 2.0
done

# Figure 12, left  path = figs/Ising_tune_comparison/D_4_w_init_2.000000_dt_0.500000_nsamp_max_50000/N_150_T_148.413159_beta_0.010000/fig2.png
