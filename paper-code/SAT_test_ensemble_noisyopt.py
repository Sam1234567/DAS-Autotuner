...
if(method == "DS"):
	res, x_list = noisyopt.minimizeCompass(obj, x0=xw_init, niter = int(nsamp_max/(R_eval*N_inst*2)) , errorcontrol = True, deltatol=0.5, feps = 0.05, paired=False)

if(method == "SPSA"):
	res, x_list = noisyopt.minimizeSPSA(obj, x0=xw_init,niter = int(nsamp_max/(R_eval*N_inst*2)) ,alpha = 0.6, gamma = 0.33, a = dt, c = w_init, paired=False)
